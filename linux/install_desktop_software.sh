...
sudo apt -y install shutter i3lock terminator rofi vlc totem \
...
kodi-addons-dev shutter fonts-firacode pcmanfm feh scrot compton aircrack-ng reaver libreoffice blueman adb qemu-kvm davfs2 gmtp pasystray
